...
public class j_challenges_b_c_goalDayStartTom extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public j_challenges_b_c_goalDayStartTom() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.clickOnText("Start Tomorrow");
        solo.sleep(500);
