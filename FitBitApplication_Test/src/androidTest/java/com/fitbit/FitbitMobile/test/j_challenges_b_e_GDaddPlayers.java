...
public class j_challenges_b_e_GDaddPlayers extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public j_challenges_b_e_GDaddPlayers() throws ClassNotFoundException {
    ...
    public void testRun() {
       ...
       // assertTrue("OutgoingInvitationActivity is not found!", solo.waitForActivity("OutgoingInvitationActivity"));
        ...
        solo.clickOnText("Add Players");
        solo.clickOnText("Aaron");
        solo.clickOnText("Only friends with the Fitbit App");
